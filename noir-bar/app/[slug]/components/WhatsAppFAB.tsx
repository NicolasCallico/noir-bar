...
export function WhatsAppFAB({ phone, message = "Hola, quiero reservar una mesa 🍸" }: Props) {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-5 right-5 z-40 w-13 h-13 flex items-center justify-center rounded-full shadow-lg"
      style={{
        width: 52,
        height: 52,
        background: "#25D366",
