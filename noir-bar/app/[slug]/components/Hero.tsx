...
export function Hero({ venue }: Props) {
  ...
  return (
    <div style={{ borderBottom: `1px solid ${venue.theme === "light" ? "#D5C5A0" : "#1a1a1a"}`, background: venue.theme === "light" ? "linear-gradient(180deg, #F0E6D0 0%, #FAF8F3 100%)" : "#0D0D0D" }} className="w-full px-4 py-3.5">
      <div className="mx-auto flex items-center gap-3 max-w-3xl">
        ...
        {venue.logo_url && (
          <div
            ...
            style={{ width: 60, height: 60, minWidth: 60, borderRadius: "50%", boxShadow: "0 0 0 1.5px rgba(200,169,107,0.4)", backgroundColor: "#1C1814" }}
          >
            <img
              src={venue.logo_url}
              alt={venue.name}
